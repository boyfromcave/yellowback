...
| `ydollar-adaptation-spec.md` | **The normative v1 protocol** — §3 of [`../plans/ydollar-v1-development-plan.md`](../plans/ydollar-v1-development-plan.md), reproduced verbatim so rule identifiers (`MINT-1`, `RED-7`, …) have one citable home. Rationale, decisions and the work plan are in the plan; this file is regenerated from it. |
